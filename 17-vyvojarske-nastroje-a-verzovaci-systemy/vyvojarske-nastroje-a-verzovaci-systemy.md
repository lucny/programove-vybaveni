...
- **Kontejner** obsahuje aplikaci a všechny její závislosti, včetně operačního systému. Kontejnery jsou **přenositelné a izolované**, což zajišťuje konzistentní běh aplikace napříč různými prostředími.
- **Dockerfile** je soubor, který popisuje, jak vytvořit Docker image, což je spustitelná instance kontejneru. Tyto obrazy lze sdílet a nasazovat na různá prostředí.
