...
**Agregace odpovídá na otázku — a část detailu zahazuje**
-----
...
***
Zpracuj v podobě encyklopedické grafiky tuto kapitolu:
**Průměr bez rozdělení může lhát**
-----
Vycházej z tohoto textu, ale k vyjádření obsahu používej hlavně grafické prvky:
-----
...
***
Zpracuj v podobě encyklopedické grafiky tuto kapitolu:
**Korelace je vodítko, nikoli rozsudek**
-----
Vycházej z tohoto textu, ale k vyjádření obsahu používej hlavně grafické prvky:
-----
...
***
Zpracuj v podobě encyklopedické grafiky tuto kapitolu:
**Vzorek, nejistota a přiměřená jistota**
-----
Vycházej z tohoto textu, ale k vyjádření obsahu používej hlavně grafické prvky:
-----
